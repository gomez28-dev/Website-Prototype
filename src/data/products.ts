  ...
  battery: {
    ...
    brandProducts: {
      enerco: [
        ...
        { name: 'NS70LMF', type: 'AGM', size: '12V 65Ah', brand: 'Enerco', warranty: 'Manufacturer Warranty', image: '/assets/images/NS70 LMF 12V 65AH_OK.webp', images: ['/assets/images/NS70 LMF 12V 65AH.webp'], desc: 'Engineered for absolute reliability that goes beyond the standard, delivering a premium power solution that moves with you. Our brand is built on four core truths that ensure you never have to worry about whats under the hood.', features: ['High performance and low discharge rate', 'Long service lifespan', 'Strong starting performance at low temperature', 'Select high quality raw materials'], specs: { 'Size': '2SM', 'Voltage': '12V', 'Capacity': '2SM (65AH)' } },
